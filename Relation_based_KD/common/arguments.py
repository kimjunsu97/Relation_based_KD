...
def parse_args():
    ...
    parser.add_argument('-cs', '--checkpoint-student', default='checkpoint', type=str, metavar='PATH', help='student checkpoint directory')
    parser.add_argument('-ct', '--checkpoint-teacher', default='checkpoint/teacher', type=str, metavar='PATH', help='teacher checkpoint directory')
    parser.add_argument('-tn', '--teacher-name', default='gt_243.bin', type=str, metavar='PATH', help='teacher name')
    ...
    parser.add_argument('-arct', '--architecture-teacher', default='3,3,3,3,3', type=str, metavar='LAYERS', help='filter widths separated by comma')
    parser.add_argument('-arcs', '--architecture-student', default='3,3,3', type=str, metavar='LAYERS', help='filter widths separated by comma')
    ...
    parser.add_argument('-lamd', '--lambda-distance', default=10, type=int, metavar='N', help='number of channels in convolution layers')
    parser.add_argument('-lama', '--lambda-angle', default=10, type=int, metavar='N', help='number of channels in convolution layers')
